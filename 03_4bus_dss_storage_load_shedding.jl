...
results_path = "results/2025-04-09_solar_carga_armazenamento_load_shedding/"
...
# solucionando modelo #
#######################
result = solve_mc_model(eng_model, ACPUPowerModel, Ipopt.Optimizer, build_mn_mc_mld_simple; multinetwork=true)
...
pm = instantiate_mc_model(eng_model, ACPUPowerModel, build_mn_mc_mld_simple, multinetwork=true)
