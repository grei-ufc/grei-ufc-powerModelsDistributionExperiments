...
results_path = "results/2025-04-09_solar_carga/"
...
#######################################
# aumentando preço do consumo da rede #
#######################################
eng_model["voltage_source"]["source"]["cost_pg_parameters"] = [100, 0]


#############################
# adicionando um nova linha #
#############################
add_line!(eng_model,
         "line3",
         "n3",
         ...
         xs=[0.000672176 0.000313963 0.000241465; 0.000313963 0.000653469 0.000265448; 0.000241465 0.000265448 0.000664048],
         length=762.0,
         status=ENABLED,
         g_to=[-1.18086e-18 1.23558e-18 1.71258e-19; 1.71807e-18 -1.14788e-18 -8.92468e-19; -1.64701e-19 5.72051e-20 7.54231e-19],
         g_fr=[-1.18086e-18 1.23558e-18 1.71258e-19; 1.71807e-18 -1.14788e-18 -8.92468e-19; -1.64701e-19 5.72051e-20 7.54231e-19],
         b_fr=[0.00468135 -0.00151075 -0.0005758; -0.00151075 0.00493236 -0.00096037; -0.0005758 -0.00096037 0.00445091],
         b_to=[0.00468135 -0.00151075 -0.0005758; -0.00151075 0.00493236 -0.00096037; -0.0005758 -0.00096037 0.00445091],
         rs=[0.00028566 9.76559e-5 9.61078e-5; 9.76559e-5 0.000291355 9.89452e-5; 9.61078e-5 9.89452e-5 0.000288121])
...
plot(time_indexes, solar_active_power .+ load_active_power, label="Balanço no barramento", linewidth=2)
plot!(time_indexes, line_active_power, label="Fluxo na Linha", linewidth=2)
...
plot!(time_indexes, bus_n4_1_voltage, label="Tensão na Fase 2", linewidth=2)
plot!(time_indexes, bus_n4_1_voltage, label="Tensão na Fase 3", linewidth=2)
